...
/* ============== */
{
  ...
  cItemTotalCost = (sum.order / index) * C_ITEM;
  ...
  printf("   item total cost .......... = %6.2f\n", cItemTotalCost);
  printf("   setup total cost ......... = %6.2f\n", cSetupTotalCost);
  printf("   hold total cost .......... = %6.2f\n", cHoldTotalCost);
  printf("   shortage total cost ...... = %6.2f	\n", cShortageTotalCost);
  fclose(fp);
  return (0);
}
